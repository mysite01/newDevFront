    ...
    <GameStatusProvider>
      <Router>
        ...
        <Routes>
          ...
          <Route path="/GamePageUser" element={<GamePageUser idOfUser='' nickName={""} email={""} host />} />
          ...
          <Route path="/details/dashboard" element={<GamePageUser idOfUser='' nickName={""} email={""} host />} />
